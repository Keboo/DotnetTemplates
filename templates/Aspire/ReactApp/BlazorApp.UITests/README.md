...
2. Ensure the BlazorApp is running at the configured base URL
...
- name: Install Playwright Browsers
  run: pwsh BlazorApp.UITests/bin/Debug/net10.0/playwright.ps1 install --with-deps

- name: Run UI Tests
  env:
    TEST_BASE_URL: https://staging.example.com
  run: dotnet test BlazorApp.UITests/BlazorApp.UITests.csproj
```
...
- task: PowerShell@2
  ...
  inputs:
    targetType: 'inline'
    script: |
      pwsh BlazorApp.UITests/bin/Debug/net10.0/playwright.ps1 install --with-deps

- task: DotNetCoreCLI@2
  displayName: 'Run UI Tests'
  inputs:
    command: 'test'
    projects: 'BlazorApp.UITests/BlazorApp.UITests.csproj'
  env:
